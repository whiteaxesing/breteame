// ============================================================================
// Breteame · Inserta los profesionales de prueba vía supabase-js (HTTP/REST).
...
const professionals = [
  ...
  },
  {
    ...
    category: "cerrajeria",
    location: "Escazú, Bello Horizonte",
...
try {
  ...
  console.log(`✓ ${professionals.length} profesionales actualizados.`);
} catch (err) {
