...
- [ ] Filtro "Emergencia 24/7" / "Disponible ahora" (fontanero o cerrajero a medianoche = el caso estrella)
- [ ] Geolocalización / "cerca de mí" y filtro por cantón más fino
- [ ] Más datos de prueba para que el demo se vea poblado, no 5 tarjetas
